...
import { InsightsBlock, Media } from '@/lib/api';
...
export default function InsightsSection({ data }: InsightsSectionProps) {
    ...
    const getImageUrl = (image: Media | string | null | undefined) => {
        ...
        // If it's a relative path from API, we might need to prepend server URL
        // checking if environment variable is set in client
