    ...
    return (
        <main className="bg-white min-h-screen relative overflow-hidden">
            ...
            <section className="pt-32 pb-10 relative z-10">
                <div className="site-container text-center space-y-4 mb-16">
                ...
                {/* Map Section */}
                <div className="site-container relative w-full h-[300px] md:h-[600px] mb-20">
                ...
                <div className="site-container grid grid-cols-1 md:hidden gap-6 mb-12">
